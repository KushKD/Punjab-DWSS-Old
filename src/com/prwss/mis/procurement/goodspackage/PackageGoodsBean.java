...
@Entity
@Table(name="t_proc_package_goods", schema=MISConstants.MIS_DB_SCHEMA_NAME)
public class PackageGoodsBean implements Serializable,Comparable<PackageGoodsBean> {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2679098534753041559L;
	...
	@Override
	public int compareTo(PackageGoodsBean o) {
