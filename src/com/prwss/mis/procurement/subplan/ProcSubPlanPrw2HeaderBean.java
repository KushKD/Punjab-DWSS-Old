...
@Entity
@Table(name="t_proc_sub_plan_prwss2", schema=MISConstants.MIS_DB_SCHEMA_NAME)
public class ProcSubPlanPrw2HeaderBean implements Serializable,Comparable<ProcSubPlanPrw2HeaderBean> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2100855839680153677L;
...
//  @SequenceGenerator(name = "seq_t_proc_subplan", sequenceName = "prwss_main.seq_t_proc_subplan")
	...
	@Override
	public int compareTo(ProcSubPlanPrw2HeaderBean o) {
