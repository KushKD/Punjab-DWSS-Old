...
@Entity
@Table(name="t_proc_package_non_consultancy", schema=MISConstants.MIS_DB_SCHEMA_NAME)
public class PackageNonConsultancyBean implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -3140681890189548373L;
