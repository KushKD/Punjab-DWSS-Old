...
public class EmployeeTransuctionalAction extends DispatchAction{
		...
		try {
			...
			if(!MisUtility.ifEmpty(employeeDesignationBeans))	{
				for(EmployeeDesignationBean empDesignationBean : employeeDesignationBeans){
					buffer.append("<option value=\"").append(empDesignationBean.getDesignationName()).append("\">");
...
//		request.setAttribute("d__ky", "employeeName@birthDateId@fatherNameId@maritalStatusId@personalEmailId@officeEmailId@genderId@category@nationalityId@employeeTypeId@designation@joiningDateId@panNoId@appointedWingId@appointmentNoId@sanctionNoId@specializationId@locationIdId@reportingOfficerId@addressLine1@addressLine2Id@streetId@cityId@pinCodeId@stateID@workPhoneNoID@mobilePhoneNoId@contractStartDateId@contractEndDateId@promotedDesignationId@promotionDateId@permanentEmployeeId@retirementDate");

		//request.setAttribute("d__ky", "employeeId@employeeName@birthDateId@fatherNameId@@addressLine1@addressLine2Id@streetId@cityId@pinCodeId@stateID@workPhoneNoID@mobilePhoneNoId@permanentEmployeeId@retirementDate@employeeTypeId@designationId");
		
		request.setAttribute("d__auto","employeeId");
		request.setAttribute("d__ky", "employeeId");
