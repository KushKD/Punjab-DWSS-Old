...
@Entity
@Table(name="vw_prwss_project_habitation_with_oh", schema=MISConstants.MIS_DB_SCHEMA_NAME)
public class PrwssVillageViewBeanWithMhOh implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 7904675980741451597L;
	...
	public String toString() {
		return "PrwssVillageViewBeanWithMhOh [villageId=" + villageId + ", villageName="
