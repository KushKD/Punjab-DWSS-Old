...
@Entity
@Table(name="notification_outgoing", schema=MISConstants.MIS_DB_SCHEMA_NAME)
public class MailNotificationBean implements Serializable {
	...
	@Id
	@SequenceGenerator(name="seq_notification", sequenceName="prwss_main.seq_notification")
	@GeneratedValue(generator="seq_notification", strategy=GenerationType.AUTO)
	...
	public String toString() {
		return "\nMailNotificationBean [notificationId=" + notificationId + ", emailTo=" + emailTo + ", emailCC="
